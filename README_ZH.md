...
* [Roslyn 分析器](https://github.com/Felid-Force-Studios/StaticEcs-Analyzer)
...
# 快速开始
> 💡 编译期检查请安装 [`FFS.StaticEcs.Analyzers`](https://github.com/Felid-Force-Studios/StaticEcs-Analyzer) —— 独立的 NuGet / UPM 包，包含 Roslyn 分析器与代码修复套件。
